...
import type { ClientView, ClientNavLink } from '../types.ts';
import { clientNavLinks, clientSettingsLink, clientUser } from '../constants.tsx';
    ...
    <>
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        <div className="flex items-center gap-3 p-2 mt-4 bg-gray-50 rounded-lg">
          ...
          />
          <div>
            <p className="font-semibold text-gray-900 text-sm">{clientUser.name}</p>
